...
const Edit: React.FunctionComponent = () => {
  ...
  const getProductById = (id: any) => {
    ProductService.getById(id)
      .then((response: IResource<IProduct>) => {
        ...
        setPublishedAt(product.published_at || '');
  ...
  const onSubmit = (e: any) => {
    ...
    ProductService.update(id, formData, { 'Content-Type': 'multipart/form-data' })
      .then((response: IResource<IProduct>) => {
        setToast({
          open: true,
          message: 'New product has been updated successfully!',
          type: 'success',
        })
        const product = response.data;
